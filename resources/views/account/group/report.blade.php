		...
		<div class="col-md-12">
			<div class="card table-card">
				<div class="card-header">
					<form class="forms-sample ajax-get-report" id="view_group_report_form" action="{{ route('group.report', $group['id']) }}" method="post">
					@csrf
				...
				<div class="card-block" id="view_group_report_form_feedback">
					<x-account.group.group_report_table :group=$group :groupStats=$group_stats :isAdmin=false />
				</div>
			</div>
		</div>
	</div>
