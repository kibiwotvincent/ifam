			...
			<div class="col-md-12">
				<div class="card table-card">
					<div class="card-header">
						<form class="ajax-get-report" id="view_groups_report_form" action="{{ route('admin.groups_report') }}" method="post">
						@csrf
						...
						<div class="d-inline-block mr-2 mb-3 mb-lg-0">
							<label>&nbsp;</label>
							<button type="submit" id="view_groups_report_form_submit" style="padding: 8px 15px 8.5px 15px; border-radius: 4px;" class="border-0 bg-success text-white">
							Submit
							</button>
						</div>
						</form>
					</div>
					<div class="card-block" id="view_groups_report_form_feedback">
						<x-account.admin.groups_report_table :groupsStats=$groups_stats />
					</div>
				</div>
			</div>
		</div>
